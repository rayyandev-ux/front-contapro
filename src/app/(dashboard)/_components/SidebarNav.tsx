...
export default function SidebarNav({ onNavigate, mobileOnly, hideAccount }: Props) {
  ...
  let list = items;
  if (mobileOnly) {
    list = list.filter((i) => i.href === '/integrations' || i.href === '/account' || i.href === '/payment-methods');
  }
  if (hideAccount) {
