  ...
  if (!res.ok) {
    return (
      <section>
        ...
        <Link href="/expenses" className="text-sm text-gray-700 hover:text-black">Volver a gastos</Link>
      </section>
    );
  }
    ...
    <section className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        {details ? (
          <>
            <div className="rounded-md border bg-white p-4">
              <div className="text-sm text-gray-500">N° Documento</div>
              <div className="text-sm">{details.docNumber || "—"}</div>
            </div>
            <div className="rounded-md border bg-white p-4">
              <div className="text-sm text-gray-500">Emisor</div>
      ...
      {document ? (
        <div className="rounded-md border bg-white p-4">
          <div className="flex items-center justify-between">
            ...
            <div className="space-x-2">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="rounded-md bg-black px-3 py-2 text-white hover:bg-gray-900"
              >Descargar</a>
              {details ? (
                <a
          ...
          <div className="mt-4">
            <div className="text-sm text-gray-500">Resumen IA</div>
            {document ? (
          ...
          {document.mimeType?.startsWith("image/") && (
            <div className="mt-4">
              ...
              <div className="mt-2 overflow-hidden rounded-md border bg-gray-50">
                <ImagePreview
