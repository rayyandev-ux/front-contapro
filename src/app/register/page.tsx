      ...
      <section className="mx-auto max-w-md px-6 py-16">
        ...
        <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <Card className="bg-white/90 backdrop-blur-sm shadow-lg ring-1 ring-black/5">
            <CardHeader>
              <CardTitle className="bg-gradient-to-r from-indigo-800 via-fuchsia-700 to-cyan-600 bg-clip-text text-transparent">Crear cuenta</CardTitle>
              ...
              <form className="space-y-4" onSubmit={onSubmit} aria-busy={loading}>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className={`${nameError ? "ring-2 ring-red-500" : ""} focus-visible:ring-indigo-500/60 focus-visible:ring-2 focus-visible:outline-none`}
                  />
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className={`${confirmError ? "ring-2 ring-red-500" : ""} pr-10 focus-visible:ring-indigo-500/60 focus-visible:ring-2 focus-visible:outline-none`}
                    />
                    <button
                      type="button"
